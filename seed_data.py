...
u4.save()
# # create questions
q1 = Question(text="Joshua went the the market to buy ___head biscuits",options=["went","arrow","sheep","cow"],answer=4)
q1.save()
q2 = Question(text="Joshua and Isaac were eating ___head biscuits ",options=["cow","arrow","went","sheep"],answer=1)
q2.save()
q3 = Question(text="Isaac exclamed that ___head biscuits were his favourite",options=["went","arrow","cow","sheep"],answer=3)
q3.save()
q4 = Question(text="Cows are the key to ___head biscuits ",options=["went","arrow","cow","sheep"],answer=3)
q4.save()
#create attempts
